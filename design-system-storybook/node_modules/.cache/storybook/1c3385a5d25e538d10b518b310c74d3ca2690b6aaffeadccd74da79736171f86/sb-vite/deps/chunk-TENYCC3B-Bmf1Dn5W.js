...
import { a as __toESM$1, r as __export, t as __commonJS } from "./chunk-XP5HYGXS-hl3AoRsF.js";
...
var getAct = async () => {
	...
	if (typeof clonedReact.act == "function") reactAct = clonedReact.act;
		...
		let deprecatedTestUtils = await import("./test-utils-CSZwGz9X.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
...
async function renderToCanvas({ storyContext, unboundStoryFn, showMain, showException, forceRemount }, canvasElement) {
	let { renderElement, unmountElement } = await import("./react-18-cnK2itpk.js"), Story = unboundStoryFn, content = storyContext.parameters.__isPortableStory ? import_react.createElement(Story, { ...storyContext }) : import_react.createElement(ErrorBoundary, {
		showMain,
		showException
...
var decorators = [(story, context) => {
	...
	let major = import_semver.default.major("19.2.8"), minor = import_semver.default.minor("19.2.8");
...
var beforeAll = async () => {
	try {
		let { configure } = await import("./dist-DgMeLj3E.js").then((n) => n.t), act = await getAct();
		configure({
