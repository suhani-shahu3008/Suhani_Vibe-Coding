import { i as __require$1, o as __toESM$1, t as __commonJSMin } from "./rolldown-runtime-CEgmsyvS.js";
import { t as require_preview_api } from "./preview-api-MpIIx04B.js";
import { t as require_client_logger } from "./client-logger-Dq6CKOwW.js";
import { dedent } from "./ts-dedent.js";
import { t as require_core_events } from "./core-events-CV-Krj_y.js";
import { t as require_react } from "./react.js";
import { C as wt, S as vr, a as Fr, f as _e$1, i as Et, n as $u, u as Wu } from "./theming-BHRdVLB9.js";
import { d as z$1 } from "./csf-BTusQogI.js";
...
import { i as gt, u as yn } from "./docs-tools-eEnlJObN.js";
...
var EmptyBlock = (props) => import_react.createElement(Wrapper, {
	...props,
...
var SourceSkeletonPlaceholder = vr.div(({ theme }) => ({
...
var Source = ({ isLoading, error, language, code, dark, format: format3 = !1, ...rest }) => {
	let { typography } = wt();
...
var DocsPageWrapper = ({ children, toc }) => import_react.createElement(DocsWrapper, { className: "sbdocs sbdocs-wrapper" }, import_react.createElement(DocsContent, { className: "sbdocs sbdocs-content" }, children), toc);
...
var IconPlaceholder = vr.div(({ theme }) => ({
	width: 14,
	height: 14,
	borderRadius: 2,
	margin: "0 7px",
...
var Toolbar = ({ isLoading, storyId, baseUrl, zoom, resetZoom, ...rest }) => import_react.createElement(Bar, { ...rest }, import_react.createElement(Wrapper2, { key: "left" }, isLoading ? [
	1,
	2,
	3
...
var StyledSource = vr(Source)(({ theme }) => ({
	margin: 0,
...
var PreviewContainer = vr.div(({ theme, withSource, isExpanded }) => ({
	position: "relative",
	overflow: "hidden",
	margin: "25px 0 40px",
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = !1, isExpanded = !1, additionalActions, className, layout = "padded", ...props }) => {
...
var FormInput = vr(QI.Input)(({ readOnly }) => ({ opacity: readOnly ? .5 : 1 }));
var FlexSpaced = vr.div(({ theme }) => ({
	flex: 1,
	display: "flex",
	input: {
		marginLeft: 10,
...
var FormInput2 = vr(QI.Input)(({ readOnly }) => ({ opacity: readOnly ? .5 : 1 }));
...
var Text = vr.span({ "[aria-readonly=true] &": { opacity: .5 } });
var Label2 = vr.label({
	lineHeight: "20px",
	alignItems: "center",
	marginBottom: 8,
...
var Text2 = vr.span({ "[aria-readonly=true] &": { opacity: .5 } });
var Label3 = vr.label({
	lineHeight: "20px",
	alignItems: "center",
	marginBottom: 8,
...
var SelectWrapper = vr.span(({ theme }) => ({
	display: "inline-block",
	lineHeight: "normal",
	overflow: "hidden",
	position: "relative",
...
var RangeCurrentAndMaxLabel = vr(RangeLabel)(({ numberOFDecimalsPlaces, max }) => ({
	width: `${numberOFDecimalsPlaces + max.toString().length * 2 + 3}ch`,
	textAlign: "right",
	flexShrink: 0
}));
var RangeWrapper = vr.div({
	display: "flex",
	alignItems: "center",
	width: "100%"
});
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-YHDXOIA2-C59h4GYA.js"));
...
var Text3 = vr.span(Pt, ({ theme, simple = !1 }) => ({
	flex: "0 0 auto",
	fontFamily: theme.typography.fonts.mono,
	fontSize: theme.typography.size.s1,
...
var ExpandButton = vr.button(({ theme }) => ({
	fontFamily: theme.typography.fonts.mono,
	color: theme.color.secondary,
	marginBottom: "4px",
	background: "none",
...
var Expandable = vr.div(Pt, ({ theme }) => ({
	fontFamily: theme.typography.fonts.mono,
	color: theme.color.secondary,
	fontSize: theme.typography.size.s1,
	margin: 0,
...
var ChevronDownIcon = vr(ChevronSmallDownIcon)({ marginLeft: 4 });
...
var renderSummaryItems = (summaryItems, isExpanded = !0) => {
...
var ArgValue = ({ value: value3, initialExpandedArgs }) => value3 == null ? import_react.createElement(EmptyArg, null) : import_react.createElement(ArgSummary, {
	value: value3,
	initialExpandedArgs
});
var Name = vr.span({ fontWeight: "bold" });
var Required = vr.span(({ theme }) => ({
	color: theme.color.negative,
	fontFamily: theme.typography.fonts.mono,
	cursor: "help"
}));
var Description = vr.div(({ theme }) => ({
	"&&": {
		p: { margin: "0 0 10px 0" },
...
var Type = vr.div(({ theme, hasDescription }) => ({
...
var TypeWithJsDoc = vr.div(({ theme, hasDescription }) => ({
	color: theme.base === "light" ? curriedTransparentize$1(.1, theme.color.defaultText) : curriedTransparentize$1(.2, theme.color.defaultText),
...
var Links = vr.div(({ theme }) => ({
	display: "flex",
	fontSize: theme.typography.size.s2 - 1,
	gap: 25
}));
var Divider = vr.div(({ theme }) => ({
	width: 1,
	height: 16,
	backgroundColor: theme.appBorderColor
}));
...
var ExpanderIconRight = vr(ChevronRightIcon)(({ theme }) => ({
	marginRight: 8,
	marginLeft: -10,
	marginTop: -2,
	height: 12,
...
var FlexWrapper = vr.span(({ theme }) => ({
	display: "flex",
	lineHeight: "20px",
	alignItems: "center"
}));
var Section = vr.td(({ theme }) => ({
	position: "relative",
...
var SkeletonText = vr.div(({ theme, width, height }) => ({
	animation: `${theme.animation.glow} 1.5s ease-in-out infinite`,
	background: theme.appBorderColor,
	width: width || "100%",
	height: height || 16,
...
var ControlHeadingWrapper = vr.span({
	display: "flex",
...
var TypeSpecimen = vr.div({
	display: "flex",
	flexDirection: "row",
	alignItems: "baseline",
	"&:not(:last-child)": { marginBottom: "1rem" }
});
var Wrapper9 = vr.div(N$1, ({ theme }) => ({
	...getBlockBackgroundStyle(theme),
	margin: "25px 0 40px",
	padding: "30px 20px"
}));
var Typeset = ({ fontFamily, fontSizes, fontWeight, sampleText, ...props }) => import_react.createElement(Wrapper9, {
	...props,
...
var ItemSubtitle = vr.div(({ theme }) => ({ color: theme.base === "light" ? curriedTransparentize$1(.2, theme.color.defaultText) : curriedTransparentize$1(.6, theme.color.defaultText) }));
var ItemDescription = vr.div({
	flex: "0 0 30%",
	lineHeight: "20px",
	marginTop: 5
});
var SwatchLabel = vr.div(({ theme }) => ({
	flex: 1,
	textAlign: "center",
	fontFamily: theme.typography.fonts.mono,
	fontSize: theme.typography.size.s1,
...
var SwatchLabels = vr.div({
	display: "flex",
	flexDirection: "row"
});
var Swatch = vr.div(({ background }) => ({
	position: "relative",
	flex: 1,
	"&::before": {
		position: "absolute",
...
var ColorPalette = ({ children, ...props }) => import_react.createElement(kp, null, import_react.createElement(List, {
	...props,
...
var IconItem = ({ name: name2, children }) => import_react.createElement(Item2, null, import_react.createElement(ItemSpecimen, null, children), import_react.createElement(ItemLabel, null, name2));
var IconGallery = ({ children, ...props }) => import_react.createElement(kp, null, import_react.createElement(List2, {
	...props,
...
var OptionalTitle = ({ title }) => title === null ? null : typeof title == "string" ? import_react.createElement(Heading, null, title) : title;
...
var Stories = ({ title = "Stories", includePrimary = !0 }) => {
...
var preview;
var ExternalDocsContainer = ({ projectAnnotations, children }) => (preview || (preview = new ExternalPreview(projectAnnotations)), import_react.createElement(DocsContext.Provider, { value: preview.docsContext() }, import_react.createElement(Et, { theme: $u(_e$1.light) }, children)));
var Meta = ({ of }) => {
	let context = (0, import_react.useContext)(DocsContext);
