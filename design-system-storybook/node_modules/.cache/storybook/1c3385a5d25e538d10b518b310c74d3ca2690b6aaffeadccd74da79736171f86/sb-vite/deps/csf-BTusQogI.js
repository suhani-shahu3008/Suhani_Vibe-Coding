...
var w = /* @__PURE__ */ s((e, r) => {
	let t = D(e);
	if (t === "") throw new Error(`Invalid ${r} '${e}', must include alphanumeric characters`);
	return t;
}, "sanitizeSafe");
var ee = /* @__PURE__ */ s((e, r) => `${w(e, "kind")}${r ? `--${w(r, "name")}` : ""}`, "toId");
var re = /* @__PURE__ */ s((e) => R(e), "storyNameFromExport");
function S(e, r) {
